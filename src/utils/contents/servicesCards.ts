...
export const objService: Array<IService> = [
  {
    ...
    description:
      "Mantenha seu pet saudável com nossos serviços de higiene e cuidados especiais.",
    serviceList: [
      {
        id: 1,
        description:
      ...
      },
      {
        id: 2,
        description:
          "A hidratação estimula o crescimento de uma pelagem saudável e brilhante.",
      },
  ...
  },
  {
    ...
    serviceList: [
      ...
      {
        id: 2,
        description: "Flexibilidade de horários para se adequar à sua agenda.",
      },
      {
        id: 3,
        description: "Ambiente tranquilo e seguro durante o transporte.",
      },
    ],
  },
  {
